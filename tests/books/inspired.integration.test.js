...
var BOOK_ROOT = path.resolve(process.cwd(), "book/inspired");
...
describe("inspired post-unzip parsing", function () {
  var fixtureFiles = [];
  ...
  it("reads OPF and resolves expected metadata", function () {
    expect(fixtureFiles.length).toBeGreaterThan(80);
    expect(packageModel.opfPath).toBe("OPS/content.opf");
    expect(opfInfo.title).toBe("INSPIRED");
