...
var BOOK_ROOT = path.resolve(process.cwd(), "book/the mom test");
...
describe("mom test post-unzip parsing", function () {
  var fixtureFiles = [];
  ...
  it("reads OPF and resolves expected metadata", function () {
    expect(fixtureFiles.length).toBeGreaterThan(40);
    expect(packageModel.opfPath).toBe("OPS/content.opf");
    expect(opfInfo.title).toBe("The Mom Test: how to talk to customers and learn if your business is a good idea when everybody is lying to you");
